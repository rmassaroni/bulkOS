...
REM Windows Terminal Canary is already installed.
REM Deleting existing settings.json...
REM Creating symbolic link for settings.json...
REM symbolic link created for C:\Users\rjm\AppData\Local\Packages\Microsoft.WindowsTerminalCanary_8wekyb3d8bbwe\LocalState\settings.json <<===>> \\wsl$\Ubuntu\home\rjm\dotfiles\WindowsTerminalCanary\settings.json
REM Windows Terminal symlink setup completed.
